...
Cirrus is EPCC's UKRI National Compute Resource.
...
to [install Zensical](https://zensical.org/docs/get-started/)
...
by running `zensical serve`. The easiest way to learn what files should look
