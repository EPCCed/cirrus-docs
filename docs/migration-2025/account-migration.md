...
Once you have been notified that you can go ahead and setup a Cirrus EX4000
account you will do this through SAFE. The URL for SAFE is:

   - [https://safe.epcc.ed.ac.uk](https://safe.epcc.ed.ac.uk)

Once you have logged into SAFE, you will need to complete the following
steps before you can log into Cirrus Ex4000 for the first time:

   1. Add Cirrus EX4000 access to your current Cirrus account
   2. (Optional) Create a new SSH key pair and add it to your ARCHER2 account in SAFE
      ...
      2. If you do not add a new SSH key to your Cirrus EX4000 account, then
         your account will use the same key as your old Cirrus account

## How do I log into Cirrus EX4000 for the first time?

You will log into Cirrus EX4000 in the same way as you logged in to old Cirrus
using SSH to access `login.cirrus.ac.uk` using an SSH key pair and TOTP. Your
TOTP will be the same as it was on old Cirrus. If you have issues, the Cirrus documentation
