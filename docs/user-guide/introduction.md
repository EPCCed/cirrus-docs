...
The Slurm workload manager provides access to a total of 640 back end or
compute nodes. All compute nodes have two 144-core AMD 9825 processors (a
total of 288 physical codes per node). There are 576 standard compute
...
- A large parallel storage system known as EPCCFS and mounted at `/epccfs`.
  The EPCCFS storage _must_ be  used for work submitted to
  Slurm.
...
*This work used the Cirrus NCR HPC Service at EPCC
(http://www.cirrus.ac.uk) funded by The University of Edinburgh,
the Edinburgh and South East Scotland City Region Deal, and UKRI.*
